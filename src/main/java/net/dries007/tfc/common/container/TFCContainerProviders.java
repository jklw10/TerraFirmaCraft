...
public class TFCContainerProviders
{
    ...
    public static final INamedContainerProvider KNAPPING = Helpers.createNamedContainerProvider(new TranslationTextComponent("tfc.screen.knapping"), (windowId, inv, player) -> new SimpleContainer(TFCContainerTypes.KNAPPING.get(), windowId, player.inventory));
}